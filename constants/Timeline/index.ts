...
export const timelinesSMC = [
  ...
  {
    title: "The process of assessment of the Preliminary Round of Short Movie",
...
export const timelinesSPC = [
  ...
  {
    title: "Rehearsal for Final",
    description: "Rehearsal session for the final stage participants.",
    month: "NOV",
    date: "5",
    year: "2024",
    color: "#E27817",
