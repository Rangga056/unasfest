//cover Image
import kdbiCover from "@/public/img/competition/kdbiCover.png"
import edcCover from "@/public/img/competition/edcCover.png"
import scpCover from "@/public/img/competition/scpCover.png"
import smcCover from "@/public/img/competition/smcCover.png"

//timeline
import {timelinesEDC} from "@/constants/Timeline/timelinesEDC"
import {timelinesKDBI} from "@/constants/Timeline/timelinesKDBI"
import {timelinesSCP} from "@/constants/Timeline/timelinesSPC"
import { timelinesSMC } from "@/constants/Timeline/timelinesSMC"
export const competitionsData = [
    {
        ...
        requirements: [
            {
                no: "01",
                provision : "Students who register themselves on the registration link that has been listed on the UNAS FEST 2023 website."
            ...
            {
                no: "03",
                provision : "Debate participants are students who have never had a Bachelor (S1) / Applied Bachelor (D4) degree."

            },
            {
                no: "04",
                provision : "Students follow the rules that have been determined and listed in the KDBI Unas Fest 2023 activity guidebook."
